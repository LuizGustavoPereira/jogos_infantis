<!-- Pagína inicial -->
<div class="row" >
	<div class="col l10 offset-l1 xl10 offset-xl1">
		<div class="titulo ">
			<h3 class="float-left blue-text" >ALFABETO</h3>			
		</div> 
	</div>
	<div class="col s12 l10 offset-l1 xl10 offset-xl1" id="telaInicial" display>
        <div class="card transparent darken-1">
            <div class="card-content blue-text"> 
	            <div class="row">
	            	<div class="col s12 l10 offset-l1 xl10 offset-xl1 center-align">
						<img class="width-50" src="imagens/alfabeto/alfabeto.png">
	            	</div>
            	</div> 
            	<div class="row center-align">
					<div class="col s12 l10 offset-l1 xl10 offset-xl1">
	...
	<div class="col l10 offset-l1" id="jogo" display>
        <div class="card transparent darken-1">
            <div class="card-content "> 
	            <div class="row">
	            	<div class="col s7 l7  xl6 offset-xl2 center-align" >
	            		<div class="col s12 l12 center-align">		            		
					        <div  id="pergunta">			        	
								
					        </div>					     		
			     		</div>
			     		<div class="col s12 l12 xl12" id="divResp">
...
<!-- GAME OVER -->
<div class="row">
	<div class="col s12 l10 offset-l1 xl10 offset-xl1" id="fim-do-jogo" display>
		<div class="card transparent darken-1">
	        <div class="card-content deep-purple-text text-darken-2"> 
		        <div class="row">
		        	<div class="titulo s12 col l10 offset-l1 xl10 offset-xl1 center-align">
	...
	<!-- GANHOU -->
	<div class="col s12 l10 offset-l1 xl10 offset-xl1" id="ganhou-jogo" display>
		<div class="card transparent darken-1">
	        <div class="card-content deep-purple-text"> 
		        <div class="row">
		        	<div class="titulo col s12 l10 offset-l1 xl10 offset-xl1 center-align">
