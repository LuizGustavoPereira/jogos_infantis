    ...
    <div class="col s12 l10 offset-l1">
        <div class="card transparent darken-1">
            <div class="card-content blue-text text-darken-2"> 
            	...
            	<div class="row">
            		<div class="col s12 l10 offset-l1 center-align" id="nomeCor">
