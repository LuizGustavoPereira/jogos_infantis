...
$routerContent->addRoutes(array(
	...
	array('GET','/descubra-palavra/',    '/descubraPalavra.php', 'descubraPalavra'),
	array('GET','/descubra-palavra',     '/descubraPalavra.php', ''),
	array('GET','/descubra-palavra/[*]', '/descubraPalavra.php', ''),
	...
	array('GET', '/info', 		'/info.php', 'info'),
	array('GET', '/info/', 	'/info.php', ''),
	array('GET', '/info/[*]', 	'/info.php', ''),
